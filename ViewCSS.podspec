...
Pod::Spec.new do |s|
  s.name             = 'ViewCSS'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ViewCSS.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Eric Chapman/ViewCSS'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Eric Chapman' => 'eric.chappy@gmail.com' }
  s.source           = { :git => 'https://github.com/Eric Chapman/ViewCSS.git', :tag => s.version.to_s }
